...
import itec.treetable.config.audit.AuditEventConverter;
import itec.treetable.domain.PersistentAuditEvent;
...
import static itec.treetable.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;

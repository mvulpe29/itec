...
import itec.treetable.domain.Location;
import itec.treetable.repository.LocationRepository;
import itec.treetable.service.LocationService;
...
public class LocationResourceIntTest {
    ...
    public void createLocation() throws Exception {
        ...
        assertThat(testLocation.getLatitute()).isEqualTo(DEFAULT_LATITUTE);
    ...
    public void updateLocation() throws Exception {
        ...
        Location testLocation = locationList.get(locationList.size() - 1);
        assertThat(testLocation.getLatitute()).isEqualTo(UPDATED_LATITUTE);
